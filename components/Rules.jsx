          ...
          <ModalBody>
            ...
            {!showRoles
              ...
              <div>
                ...
                <p>  If the magic word was guessed, a vote for the Wolf team is started, in which they can try to guess and vote for the Seer. If they guess correctly, the Wolf team wins. If they do not guess correctly, the Village team wins.</p>

                <p>  If the magic word was not guessed, a vote for the Village team is started, in which all players can try to guess and vote for one of the wolves. If they guess correctly, the Village team wins. If they do not guess correctly, the Wolf team wins.</p>
                ...
                <ul style={{ 'list-style-position': 'inside' }}>
                  ...
                  <li>As a Villager, try to not only ask helpful questions, but also keep track of who asked what, so you have an idea on who may be a Wolf later on.</li>
                  <li>As a Seer, try to help your team by asking helpful questions, but do not make it too obvious that you are the Seer, so the Wolves will not vote for you later on. Since you know the magic word, you can also more easily recognize who is un-helpful, leading to a better guess on the Wolves.</li>
                  <li>As a Wolf, try to ask misleading questions, but do not make it too obvious that you are a Wolf, so you do not get voted for later on. Another good set of questions are questions, where the helpful answer to the question is not technically correct. Since you know the magic word, you can also more easily recognize who is especially helpful, leading to a better guess on the Seer.</li>
                ...
                <ul style={{ 'list-style-position': 'inside' }}>
                  <li>The mayor can have any role other players can have as well. If the mayor is a Wolf, he may lie when answering questions. If the mayor is a Seer, he may chose an easy word to guess.</li>
                  <li>In a vote for the village team, all players (including the Wolves) get to vote.</li>
                  <li>The vote at the end of the game does not need to result in a majority. If any of the players with the most votes are wolf/seer, the voting will succeed.</li>
                </ul>
              </div>
              )}
          </ModalBody>
          <ModalFooter>
            <Button colorScheme="blue" mr={3} onClick={() => { onRulesClose(); setShowRoles(false); }}>
              Close
            </Button>
          </ModalFooter>
        </ModalContent>
